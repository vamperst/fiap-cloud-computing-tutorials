...
1. No terminal do CLoud 9 IDE criado no cloud9 execute o comando `cd ~/environment/fiap-serverless-architecture-tutorials/04-SQS/01\ -\ Standard\ Queue/` para entrar na pasta que fara este exercicio.
